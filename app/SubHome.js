...
const SubHome = () => {
  return (
    ...
    <View className='flex flex-col laptop:w-[70%] desktop:w-[70%] tablet:w-[70%] w-full justify-start  shadow-2xl py-6  px-3 space-y-5'>
      <Text className="text-4xl font-bold">What is Komparas?</Text>
